<template>
    <div class="page">
        <div class="container">
            ...
            <h3>H3: I Considered “Us” With Quiet Interest</h3>
            ...
            <p>
                ...
                <small>
                — Olaf Stapledon,
                <cite title="Star Maker">Star Maker</cite>
                </small>
            </p>
            </blockquote>
            ...
            <h4>H4: But Now Irrationally I Was Seized</h4>
            ...
            <h5>H5: And Yet the Heart Praised</h5>
            ...
            <h6>H6: Considered Even Without Reference to Our Belittling Cosmical Background</h6>
            ...
            <p>
            <strong>Yes!</strong>
            <em>How predestinate had seemed our union!</em> Yet now, in retrospect, how accidental. True,
            <del>of course</del>, that as a long-married couple we
            <kbd>fitted</kbd> rather neatly, like
            <small>two close trees whose trunks</small> have grown upwards together as a single shaft, mutually distorting, but mutually supporting.
            <abbr
